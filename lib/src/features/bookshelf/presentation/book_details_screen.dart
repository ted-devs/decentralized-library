              ...
              children: [
                ...
                if (isOwner) ...[
                  SwitchListTile(
                    ...
                    onChanged: _isLoading || widget.transaction != null
                        ? null
                        : _toggleShareability,
                    title: const Text('Available for sharing'),
                    subtitle: widget.transaction != null
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                              'Status: ${_getStatusLabel(widget.transaction!.status)}'
                                  .toUpperCase(),
                              style: TextStyle(
