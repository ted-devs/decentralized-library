const List<String> countries = [
  ...
  "🇨🇦 Canada", "🇨🇨 Cocos (Keeling) Islands", "🇨🇩 Congo - Kinshasa", 
  "🇨🇫 Central African Republic", "🇨🇬 Congo - Brazzaville", "🇨🇭 Switzerland", 
  "🇨🇮 Côte d’Ivoire", "🇨🇰 Cook Islands", "🇨🇱 Chile", "🇨🇲 Cameroon", "🇨🇳 China", 
  "🇨🇴 Colombia", "🇨🇵 Clipperton Island", "🇨🇷 Costa Rica", "🇨🇺 Cuba", "🇨🇻 Cape Verde", 
  "🇨🇼 Curaçao", "🇨🇽 Christmas Island", "🇨🇾 Cyprus", "🇨🇿 Czechia", "🇩🇪 Germany", 
  "🇩🇬 Diego Garcia", "🇩🇯 Djibouti", "🇩🇰 Denmark", "🇩🇲 Dominica", 
  "🇩🇴 Dominican Republic", "🇩🇿 Algeria", "🇪🇦 Ceuta & Melilla", "🇪🇨 Ecuador", 
  ...
  "🇬🇶 Equatorial Guinea", "🇬🇷 Greece", "🇬🇸 South Georgia & South Sandwich Islands", 
  "🇬🇹 Guatemala", "🇬🇺 Guam", "🇬🇼 Guinea-Bissau", "🇬🇾 Guyana", "🇭🇰 Hong Kong SAR China", 
  "🇭🇲 Heard & McDonald Islands", "🇭🇳 Honduras", "🇭🇷 Croatia", "🇭🇹 Haiti", 
  "🇭🇺 Hungary", "🇮🇨 Canary Islands", "🇮🇩 Indonesia", "🇮🇪 Ireland", "🇮🇱 Israel", 
  ...
  "🇸🇹 São Tomé & Príncipe", "🇸🇻 El Salvador", "🇸🇽 Sint Maarten", "🇸🇾 Syria", 
  "🇸🇿 Eswatini", "🇹🇦 Tristan da Cunha", "🇹🇨 Turks & Caicos Islands", "🇹🇩 Chad", 
  ...
  "🇺🇦 Ukraine", "🇺🇬 Uganda", "🇺🇲 U.S. Outlying Islands", "🇺🇳 United Nations", 
  ...
  "🇼🇸 Samoa", "🇽🇰 Kosovo", "🇾🇪 Yemen", "🇾🇹 Mayotte", "🇿🇦 South Africa", 
  "🇿🇲 Zambia", "🇿🇼 Zimbabwe"
];
